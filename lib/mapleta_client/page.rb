module Maple::MapleTA
  ...
  module Page
    ...
    def self.classes
      [AssignmentQuestion, StudyQuestion, Grade, RestrictedAssignment, TimeLimitExceeded, OtherActiveAssignment, ProctorAuthorization, PrintOrTake, PrintAssignment, Error]
    end
